    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_home:
                ...
                intent = new Intent(GalleryActivity.this, HotelProfile.class);
            ...
            case R.id.nav_about:
                ...
                intent = new Intent(GalleryActivity.this, AdsActivity.class);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.nav_account:
                ...
                intent = new Intent(GalleryActivity.this, User_Profile.class);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.nav_logout:
                ...
                intent = new Intent(GalleryActivity.this, LoginActivity.class);
                startActivity(intent);
                finish();
                break;
